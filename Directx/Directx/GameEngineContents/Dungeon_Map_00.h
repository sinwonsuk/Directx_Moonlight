...
class Dungeon_Map_00 : public GameEngineActor, public Map_Manager
{
public:
	...
	// delete Function
	Dungeon_Map_00(const Dungeon_Map_00& _Other) = delete;
	Dungeon_Map_00(Dungeon_Map_00&& _Other) noexcept = delete;
	Dungeon_Map_00& operator=(const Dungeon_Map_00& _Other) = delete;
	Dungeon_Map_00& operator=(Dungeon_Map_00&& _Other) noexcept = delete;
