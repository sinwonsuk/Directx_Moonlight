...
class Dungeon_Map_07 : public GameEngineActor, public Map_Manager
{
public:
	...
	// delete Function
	Dungeon_Map_07(const Dungeon_Map_07& _Other) = delete;
	Dungeon_Map_07(Dungeon_Map_07&& _Other) noexcept = delete;
	Dungeon_Map_07& operator=(const Dungeon_Map_07& _Other) = delete;
	Dungeon_Map_07& operator=(Dungeon_Map_07&& _Other) noexcept = delete;
