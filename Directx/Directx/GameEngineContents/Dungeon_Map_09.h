...
class Dungeon_Map_09 : public GameEngineActor, public Map_Manager
{
public:
	...
	// delete Function
	Dungeon_Map_09(const Dungeon_Map_09& _Other) = delete;
	Dungeon_Map_09(Dungeon_Map_09&& _Other) noexcept = delete;
	Dungeon_Map_09& operator=(const Dungeon_Map_09& _Other) = delete;
	Dungeon_Map_09& operator=(Dungeon_Map_09&& _Other) noexcept = delete;
