...
class Dungeon_Map_08 : public GameEngineActor, public Map_Manager
{
public:
	...
	// delete Function
	Dungeon_Map_08(const Dungeon_Map_08& _Other) = delete;
	Dungeon_Map_08(Dungeon_Map_08&& _Other) noexcept = delete;
	Dungeon_Map_08& operator=(const Dungeon_Map_08& _Other) = delete;
	Dungeon_Map_08& operator=(Dungeon_Map_08&& _Other) noexcept = delete;
