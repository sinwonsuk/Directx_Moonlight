...
class Dungeon_Map_03 : public GameEngineActor, public Map_Manager
{
public:
	...
	// delete Function
	Dungeon_Map_03(const Dungeon_Map_03& _Other) = delete;
	Dungeon_Map_03(Dungeon_Map_03&& _Other) noexcept = delete;
	Dungeon_Map_03& operator=(const Dungeon_Map_03& _Other) = delete;
	Dungeon_Map_03& operator=(Dungeon_Map_03&& _Other) noexcept = delete;
