...
class Dungeon_Map_06 : public GameEngineActor, public Map_Manager
{
public:
	...
	// delete Function
	Dungeon_Map_06(const Dungeon_Map_06& _Other) = delete;
	Dungeon_Map_06(Dungeon_Map_06&& _Other) noexcept = delete;
	Dungeon_Map_06& operator=(const Dungeon_Map_06& _Other) = delete;
	Dungeon_Map_06& operator=(Dungeon_Map_06&& _Other) noexcept = delete;
