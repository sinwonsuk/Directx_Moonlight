...
class Dungeon_Map_05 : public GameEngineActor, public Map_Manager
{
public:
	...
	// delete Function
	Dungeon_Map_05(const Dungeon_Map_05& _Other) = delete;
	Dungeon_Map_05(Dungeon_Map_05&& _Other) noexcept = delete;
	Dungeon_Map_05& operator=(const Dungeon_Map_05& _Other) = delete;
	Dungeon_Map_05& operator=(Dungeon_Map_05&& _Other) noexcept = delete;
